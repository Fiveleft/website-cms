...
/*-------------------------------------------------------------------------------------------*/
/* fiveleft_agency Post Type */
/*-------------------------------------------------------------------------------------------*/
class fiveleft_agency {

	private $nonce;
	
	function fiveleft_agency() {
		$this->nonce = wp_create_nonce( 'fiveleft_agency_meta' );
		add_action('init',array($this,'create_post_type'));
		add_action('admin_init',array($this,'meta_init'));
		add_filter('manage_fiveleft_agency_posts_columns', array($this,'column_headers'), 10 );
		add_action('manage_fiveleft_agency_posts_custom_column', array($this,'custom_columns'), 10, 2);
		add_filter('manage_edit-fiveleft_agency_sortable_columns', array($this,'sortable_columns'), 10, 2 );	
	}
	...
	function create_post_type() {
		$labels = array(
		    ...
		    'add_new_item' => 'Create a New Agency',
...
//			'show_in_menu' => true,
		...
		register_post_type('fiveleft_agency',$args);
	}
	...
	function meta_init()
	{
		...
		add_meta_box( 'fiveleft_agency_meta', 'Business Details', array($this,'meta_details_setup'), 'fiveleft_agency', 'normal', 'high');
...
$fiveleft_agency = new fiveleft_agency();					
